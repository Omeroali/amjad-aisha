...
export default function AudioPlayer({ isPlaying, onToggle, audioRef }: AudioPlayerProps) {
  ...
  return (
    <motion.div
      ...
      className="hidden fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 backdrop-blur-xl bg-gradient-to-br from-white/95 to-brand-faint/90 shadow-2xl border border-brand-border/50 rounded-2xl overflow-hidden transition-all duration-300"
